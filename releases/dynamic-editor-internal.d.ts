...
/**@alpha */
export declare const editor: MinecraftEditor;

/**@alpha */
declare class Extension { private constructor()}
...
/**@alpha */
declare class MinecraftEditor { private constructor(); readonly log: Logger; registerExtension_Internal(extensionName: string, activationFunction: (arg0: ExtensionContext)=>void, shutdownFunction: (arg0: ExtensionContext)=>void, options?: ExtensionOptionalParameters): Extension}
